...
export default function AdminForgotPassword() {
    ...
    const handleSendOTP = async (e) => {
        ...
        try {
            const res = await fetch(`${api}/api/auth/forgot-password-admin`, {
                method: "POST",
    ...
    const handleVerifyOTP = async (e) => {
        ...
        try {
            const res = await fetch(`${api}/api/auth/verify-otp-admin`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-3xl shadow-2xl p-8 transition-all duration-300 mx-auto overflow-hidden">
                ...
                {/* Back Button */}
                <button 
                    onClick={() => step > 1 ? setStep(step - 1) : navigate("/admin/login")}
                ...
                <div className="flex flex-col items-center mb-6 text-center mt-4">
                    ...
                    <h2 className="text-2xl font-bold text-white tracking-tight">Recover Admin Account</h2>
