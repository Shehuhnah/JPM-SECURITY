...
import { Search, UserCheck, FileText, Trash2, Eye, User  } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row justify-between mb-6 gap-3">
        <div className="flex gap-3">
          <select
            ...
            className="bg-[#1e293b] border border-gray-700 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500"
          >
            ...
            {filteredApplicants.length === 0 ? (
              ...
              filteredApplicants.map((a) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">{a.position || "Security Guard"}</td>
                  <td
